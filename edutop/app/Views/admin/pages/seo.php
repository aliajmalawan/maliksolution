<h1 class="h4 mb-4">SEO &mdash; <?= e($page['title']) ?></h1>

<?php include __DIR__ . '/_tabs.php'; ?>

<div class="card border-0 shadow-sm" style="max-width: 720px;">
    <div class="card-body">
        <form method="POST" action="<?= url('/admin/pages/' . $page['id'] . '/seo') ?>">
            <?= csrf_field() ?>

            <div class="mb-3">
                <label class="form-label">SEO Title</label>
                <input type="text" name="seo_title" class="form-control" value="<?= e($seo['seo_title'] ?? '') ?>" placeholder="<?= e($page['title']) ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="meta_keywords" class="form-control" value="<?= e($seo['meta_keywords'] ?? '') ?>" placeholder="comma, separated, keywords">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="form-text">Must be valid JSON. Leave blank to omit.</div>
            </div>
